function initializeAccountPage() {
    ...
    updateNameForm.addEventListener('submit', async (e) => {
        ...
        if (error) {
            showStatusMessage(updateNameStatus, `Erro ao atualizar nome: ${error.message}`, true);
        } else {
    ...
    updatePasswordForm.addEventListener('submit', async (e) => {
        ...
        if (error) {
            showStatusMessage(updatePasswordStatus, `Erro ao atualizar senha: ${error.message}`, true);
        } else {
